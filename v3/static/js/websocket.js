const ws=new WebSocket((location.protocol==="https:"?"wss":"ws")+"://"+location.host+"/ws");ws.onmessage=e=>{const d=JSON.parse(e.data);if(d.type!=="dashboard_update")return;balance.innerText=d.summary.balance+" USDT";open_positions.innerText=d.summary.open_positions;risk.innerText=d.summary.risk;upnl.innerText=d.summary.upnl+" USDT";upnl.className="value "+(Number(d.summary.upnl)>=0?"green":"red");};
function renderAI(d){
