...
<h2>⚙️ Scheduler Status</h2><div class="grid"><div class="card"><div id="scheduler_status">Loading Scheduler...</div></div></div>\n<h2>🔥 Top 3 Opportunities</h2><div class="grid"><div class="card"><div id="top_opportunities">Loading Top 3...</div></div></div>
...
<p class='muted'>服務：agmcis / agmcis-opportunity / agmcis-position / agmcis-report</p><script src='https://cdn.jsdelivr.net/npm/chart.js'></script><script src='/static/js/api.js?v=76'></script><script src='/static/js/dashboard.js?v=v88_heartbeat'></script></body></html>"""
