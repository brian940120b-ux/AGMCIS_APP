...
<p class='muted'>服務：agmcis / agmcis-opportunity / agmcis-position / agmcis-report</p><script src='https://cdn.jsdelivr.net/npm/chart.js'></script><script src='/static/js/api.js'></script><script src='/static/js/dashboard.js?v=75'></script></body></html>"""
